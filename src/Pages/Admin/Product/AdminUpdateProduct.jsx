                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={PostInputData}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3 mb-3">
                                    <label>Brand*</label>
                                    <select name="brandcategory" value={data.brand} className='form-select border-3 border-primary'>
                                        {
                            ...
                            <div className="row">
                                ...
                                <div className='col-md-6 mb-3'>
                                    <label>Size*</label>
                                    <input type='number' name='size' value={data.size} onChange={getInputData} placeholder='Product Size' className={`form-control border-3 ${show && errorMessage.size ? 'border-danger' : 'border-primary'}`} />
