            ...
            <div className='container-fluid my-3'>
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary w-100 p-2 text-center text-light'>Maincategory<Link to="/admin/maincategory"><i className='fa fa-long-arrow-left text-light float-end'></i></Link></h5>
                        <form onSubmit={PostInputData}>
                            <div className='mb-3'>
                                <label>Name*</label>
                                <input type='text' name='name' onChange={getInputData} placeholder='Maincategory Name' className={`form-control border-3 ${show && errorMassage.name ? 'border-danger' : 'border-primary'}`} />
                                {show && errorMassage.name ? <p>{errorMassage.name}</p> : null}
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label>Pic*</label>
                                    <input type='file' name='pic'multiple onChange={getInputData} className={`form-control border-3 ${show && errorMassage.pic ? 'border-danger' : 'border-primary'}`} />
