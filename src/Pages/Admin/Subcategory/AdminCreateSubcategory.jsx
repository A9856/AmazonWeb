                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={PostInputData}>
                            <div className='mb-3'>
                                <label>Name*</label>
                                <input type='text' name='name' onChange={getInputData} placeholder='Subcategory Name' className={`form-control border-3 ${show && errorMassage.name ? 'border-danger' : 'border-primary'}`} />
