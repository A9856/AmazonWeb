            ...
            <div className='container-fluid my-3'>
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary w-100 p-2 text-center text-light'>Subcategory<Link to="/admin/subcategory"><i className='fa fa-long-arrow-left text-light float-end'></i></Link></h5>
                        <form onSubmit={PostInputData}>
                            <div className='mb-3'>
                                <label>Name*</label>
                                <input type='text' name='name'value={data.name} onChange={getInputData} placeholder='Subcategory Name' className={`form-control border-3 ${show && errorMassage.name ? 'border-danger' : 'border-primary'}`} />
