...
export default function AdminBrand() {
    ...
    function getAPIData() {
        dispatch(getBrand())
        // console.log("🧾 State data length:", BrandStateData.length);
            ...
            <div className='container-fluid my-3'>
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary w-100 p-2 text-center text-light'>Brand<Link to="/admin/brand/create"><i className='fa fa-plus text-light float-end'></i></Link></h5>
...
//         if (window.confirm("Are you sure to Delete that Item : ")) {
//             let response = await fetch(process.env.REACT_APP_BACKEND_SERVER + "Brand/" + id, {
//                 method: "DELETE",
//                 headers: {
...
//         let response = await fetch(process.env.REACT_APP_BACKEND_SERVER + "Brand", {
//             method: "GET",
//             headers: {
//                 "content-type": "application/json"
//             }
