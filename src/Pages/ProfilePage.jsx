  ...
  return (
    <>
      ...
      <div className="container my-3">
        ...
        <h5 className='bg-dark text-center p-2 text-light'>Wishlist Section</h5>
        {
          Wishlist.length ?
            <>
                  ...
                  <tbody>
                    {
                      Wishlist.map(item => {
                        return <tr key={item.id}>
                          ...
                          <td>&#8377;{item.price}</td>
                          <td><Link to={`/product/${item.product}`}><i className='fa fa-shopping-cart fs-4'></i></Link></td>
        ...
        <h5 className='bg-dark text-center p-2 text-light'>Order History Section</h5>
        {
          orders.length ?
            <>
              {
